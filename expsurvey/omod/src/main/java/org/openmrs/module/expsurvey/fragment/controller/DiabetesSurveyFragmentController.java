...
public class DiabetesSurveyFragmentController {
	...
	public String saveDiabetesSurvey(@RequestParam Map<String, String> requestParams) {
		for(Entry<String, String> entry : requestParams.entrySet()) {
			log.warn(String.format("SurveyFragmentPost: key:%s||value:%s", entry.getKey(), entry.getValue()));
		}
		log.warn("dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
		return null;
	}
}
